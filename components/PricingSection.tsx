    ...
    <div className="relative z-20 py-20 md:py-32 px-6 md:px-12 lg:px-24 flex flex-col justify-center">
      <div className="max-w-7xl mx-auto w-full">
        <div className="text-center mb-16 md:mb-24">
          ...
          <h2 className="text-[30px] md:text-5xl lg:text-6xl font-light mb-6 md:mb-8">Flexible <span className="font-medium italic">BioSaaS</span> Model</h2>
          <p className="text-white/80 text-[16px] md:text-base max-w-2xl mx-auto font-light leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-8 mb-20 md:mb-32">
          <div className="glass-effect p-8 md:p-14 rounded-[32px] md:rounded-[40px] border border-blue-400/30 bg-blue-400/5 shadow-[0_0_50px_rgba(96,165,250,0.05)] relative overflow-hidden group hover:border-blue-400/50 hover:-translate-y-2 transition-all duration-500">
            ...
            <ul className="space-y-4 md:space-y-6 mb-10 md:mb-12">
              {[
                ...
                <li key={i} className="flex items-center gap-3 md:gap-4 text-[16px] md:text-base text-white font-light group/item">
          ...
          <div className="flex flex-col justify-center space-y-8 md:space-y-12 p-2 md:p-4">
            <div className="group hover:-translate-x-1 transition-transform duration-500">
              ...
              <p className="text-[16px] md:text-sm text-white/80 leading-relaxed font-light group-hover:text-white transition-colors">System enablement includes secure data mapping, LIS certification, and clinical report template design to match your lab standards.</p>
            </div>
            <div className="group hover:-translate-x-1 transition-transform duration-500">
              <h4 className="text-xs md:text-sm font-bold uppercase tracking-widest text-blue-300 mb-3 md:mb-4 flex items-center gap-3 group-hover:text-blue-400 transition-colors">
                <span className="w-4 md:w-6 h-[1px] bg-blue-300 group-hover:w-10 transition-all duration-500"></span> Scalability
              </h4>
              <p className="text-[16px] md:text-sm text-white/80 leading-relaxed font-light group-hover:text-white transition-colors">Commercial models are tiered based on your laboratory's CBC throughput, ensuring unit economics align with your operational growth.</p>
            </div>
            <div className="group hover:-translate-x-1 transition-transform duration-500">
              <h4 className="text-xs md:text-sm font-bold uppercase tracking-widest text-blue-300 mb-3 md:mb-4 flex items-center gap-3 group-hover:text-blue-400 transition-colors">
                <span className="w-4 md:w-6 h-[1px] bg-blue-300 group-hover:w-10 transition-all duration-500"></span> Continuous Value
              </h4>
              <p className="text-[16px] md:text-sm text-white/80 leading-relaxed font-light group-hover:text-white transition-colors">Subscription includes all algorithm updates, security patches, and regulatory alignment updates as Clinomic Labs evolves.</p>
            </div>
          </div>
        </div>
        ...
        <div className="glass-effect p-8 md:p-12 rounded-[32px] md:rounded-[40px] border border-white/10 bg-white/[0.01] hover:border-white/20 hover:-translate-y-1 transition-all duration-500 group">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-10 md:gap-12">
            <div className="max-w-xl">
              ...
              <p className="text-white/80 text-[16px] md:text-sm font-light leading-relaxed mb-6 md:mb-8 group-hover:text-white transition-colors">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-2 text-[16px] md:text-xs text-white group/item">
